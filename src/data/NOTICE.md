# Data files — license notice

The JSON files in this directory (`scores.json`, `scores.sample.json`,
`indicator-meta.json`, and any future score / methodology output emitted
into this directory) constitute the **methodology and data outputs** of
the Thailand Liveability Index.
...
covered by either the MIT or CC BY-NC 4.0 licenses. See
[`/TRADEMARK.md`](../../TRADEMARK.md).

JSON files do not support inline comments, so this notice exists in
markdown form rather than as a per-file header. The license boundary
is unambiguous: data files in this directory are CC BY-NC 4.0
